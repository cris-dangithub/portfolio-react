  ...
  return (
    <section className='c-about'>
      <main className='about__left-content'>
        ...
        <div className='about__btns-container'> {/* 200 ms */}
          <button className='u-button about__btn' onClick={showTechnologies}>View technologies</button>
          <button className='u-button about__btn' onClick={showStudies}>View studies</button>
        </div>
      </main>
